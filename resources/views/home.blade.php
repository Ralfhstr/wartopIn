        ...
        <div class="container mt-4">
            <div class="row mb-0">
                <div class="col-lg-9 col-xl-6">
                    <h1 class="mb-3 font">{{ $pageTitle }}</h1>
                </div>
                <div class="container">
                    @if(session('success'))
            ...
            <div class="row">
                @foreach ($products as $product)
                    <div class="card align-items-center" style="width: 18rem; border-radius:30px;margin: 0 30px">
                        ...
                        <p class="btn-holder my-3"><a href="{{ route('add_to_cart', $product->id) }}" class="btn btn-primary btn-block text-center" role="button">Add to cart</a> </p>
                        </div>
                    </div>
                @endforeach
            </div>

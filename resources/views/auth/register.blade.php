            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  <p class="h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style="color: #FFF500">Sign Up</p>
                  <form class="mx-1 mx-md-4" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-10">
                            <input id="uphone" type="text" class="form-control @error('phone') is-invalid @enderror" name="uphone" value="{{ old('uphone') }}" required autocomplete="uphone" placeholder="Nomor Telpon">
                            @error('Phone Number')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-10">
                            <input id="level" type="hidden" class="form-control @error('level') is-invalid @enderror" name="level" value="user" required autocomplete="current-password" placeholder="Masukkan Password">
                            @error('level')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
